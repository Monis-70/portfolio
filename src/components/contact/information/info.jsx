...
const ContactCard = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      id: "linkedin",
      icon: FaLinkedin,
      url: "www.linkedin.com/in/monis-mansuri-b78b05283",
      color: "text-blue-400",
      hoverBg: "bg-blue-500",
      label: "LinkedIn",
    },
    ...
    },
    {
      id: "instagram",
      icon: FaInstagram,
      url: "https://www.instagram.com/haider_21_70",
      color: "text-pink-400",
      hoverBg: "bg-pink-500",
      label: "Instagram",
    },
  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      content: "mansurimonis8@gmail.com",
      isLink: true,
      url: "mailto:mansurimonis8@gmail.com",
      color: "text-indigo-300",
      label: "Email",
    },
    {
      icon: FaPhone,
      content: "+91 9321739874",
      isLink: false,
      color: "text-blue-300",
      label: "Phone",
    },
